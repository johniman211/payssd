...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'Facebook',
      href: 'https://facebook.com/payssd',
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/payssd',
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center text-gray-300">
                  ...
                  <span className="text-sm">+211929385157</span>
                </div>
                <div className="flex items-center text-gray-300">
                  <EnvelopeIcon className="h-5 w-5 mr-3 flex-shrink-0" />
                  <span className="text-sm">support@payssd.com</span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-6 mb-4 md:mb-0">
              <p className="text-gray-400 text-sm">
                © {currentYear} PaySSD. All rights reserved.
              </p>
              <div className="flex items-center space-x-2">
                <span className="text-gray-400 text-sm">Made with</span>
                <span className="text-red-500">❤️</span>
                <span className="text-gray-400 text-sm">in South Sudan</span>
              </div>
            </div>
        ...
        <div className="border-t border-gray-800 py-6">
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8">
            <div className="flex items-center space-x-2">
              <div className="h-6 w-6 bg-success-500 rounded-full flex items-center justify-center">
            ...
            <div className="flex items-center space-x-2">
              <div className="h-6 w-6 bg-warning-500 rounded-full flex items-center justify-center">
                <svg className="h-4 w-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <span className="text-gray-400 text-sm">Licensed in South Sudan</span>
            </div>
          </div>
        </div>
      </div>
